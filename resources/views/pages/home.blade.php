...
@section('content')
    ...
    <div class="other">
        <div class="frontTirth text-center p-30">
            ...
            <div class="container">
                ...
                <div class="slidecontent">
                    <span class="content1 w-100 d-flex flex-column d-flex flex-column align-items-start">
                        <img src="contact.jpg" class="image br-20" width="300px">
                    </span>
                    <span class="content2 w-100 d-flex flex-column d-flex flex-column align-items-end">
                        <img src="contact.jpg" class="image br-20" width="300px">
                    </span>
                    <span class="contentChoose w-100 d-flex flex-column d-flex flex-column align-items-start">
                        <img src="contact.jpg" class="image br-20" width="300px">
                    </span>
                    <span class="content3 w-100 d-flex flex-column d-flex flex-column align-items-end">
                        <img src="contact.jpg" class="image br-20" width="300px">
                    </span>
                    <span class="contentChoose2 w-100 d-flex flex-column d-flex flex-column align-items-start">
                        <img src="contact.jpg" class="image br-20" width="300px">
                    </span>
                </div>
            </div>
